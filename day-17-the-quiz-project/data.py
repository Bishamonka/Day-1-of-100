# Head over to https://opentdb.com/api_config.php and Generate API URL. Open that link and past data here.
# The last — get rid of unnecessary code
# You can also 'Reformat Code' if you want.
